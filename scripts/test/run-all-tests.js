...
const SIYUAN_SKILL_DIR = path.join(__dirname, '../.trae/skills/siyuan-skill');
...
function createRootDoc(title) {
    ...
    const output = execSync(cmd, { encoding: 'utf-8', cwd: SIYUAN_SKILL_DIR });
...
function deleteRootDoc(docId, title) {
    ...
    execSync(cmd, { encoding: 'utf-8', cwd: SIYUAN_SKILL_DIR });
}
